...
<div style="max-width: 800px; margin: 0 auto;">
    <div style="display: flex; align-items: center; gap: var(--space-4); margin-bottom: var(--space-8);">
        ...
        <div>
            ...
            <p class="body" style="color: var(--slate-400);">Perbarui informasi event yang telah ada.</p>
        </div>
    </div>
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <select name="partner_id" class="input" style="appearance: none;">
                            <option value="" {{ is_null($event->partner_id) ? 'selected' : '' }}>— Tidak Ada —</option>
                ...
                <div class="form-group">
                    ...
                    @if($event->poster_path && Storage::disk('public')->exists($event->poster_path))
                        <div style="margin-bottom: var(--space-4);">
                            <p class="caption" style="color: var(--slate-400); margin-bottom: var(--space-2);">POSTER SAAT INI:</p>
                            <div style="width: 120px; border: 1px solid var(--slate-700); box-shadow: var(--shadow-hard-sm); overflow: hidden; background-color: var(--slate-0);">
