...
<div style="max-width: 800px; margin: 0 auto;">
    <div style="display: flex; align-items: center; gap: var(--space-4); margin-bottom: var(--space-8);">
        ...
        <div>
            ...
            <p class="body" style="color: var(--slate-400);">Ubah rincian informasi partner di bawah ini.</p>
        </div>
    </div>
    ...
    <div class="card" style="padding: 0; overflow: hidden;">
        <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST">
            ...
            <div style="padding: var(--space-8); display: flex; flex-direction: column; gap: var(--space-6);">
                <div style="display: flex; align-items: center; gap: var(--space-4); padding: var(--space-4); background-color: var(--purple-500); border: 1px solid var(--slate-700); box-shadow: var(--shadow-hard-sm);">
                    <div style="width: 64px; height: 64px; border: 1px solid var(--slate-700); background-color: var(--slate-0); display: flex; align-items: center; justify-content: center; overflow: hidden;">
                    ...
                    <div>
                        ...
                        <p class="caption" style="color: #ffffff; margin: 0; font-weight: 700;">Ditambahkan: {{ $partner->created_at ? $partner->created_at->format('d M Y, H:i') : '-' }}</p>
                    </div>
                </div>
