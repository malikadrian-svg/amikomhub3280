            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors group">
                        <td class="p-5">
                            <img src="{{ $partner->logo_url }}" alt="{{ $partner->name }}" class="w-12 h-12 object-cover rounded-xl border border-slate-200">
                        </td>
                        <td class="p-5">
                        ...
                        <td class="p-5 flex justify-end gap-2">
                            ...
                            <form action="{{ route('admin.partners.destroy', $partner->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Anda yakin ingin menghapus data partner ini secara permanen?');">
                                @csrf
                                @method('DELETE')
                    ...
                    <tr>
                        <td colspan="4" class="p-8 text-center text-slate-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-base font-medium">Belum ada partner yang ditambahkan.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
