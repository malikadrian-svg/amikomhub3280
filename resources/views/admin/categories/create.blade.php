...
<div style="max-width: 800px; margin: 0 auto;">
    <div style="display: flex; align-items: center; gap: var(--space-4); margin-bottom: var(--space-8);">
        ...
        <div>
            ...
            <p class="body" style="color: var(--slate-400);">Masukkan nama kategori baru untuk event.</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div style="padding: var(--space-8); display: flex; flex-direction: column; gap: var(--space-6);">
                <div class="form-group">
                    ...
                    @enderror
                    <p class="caption" style="color: var(--slate-400); margin-top: var(--space-2); font-weight: 700;">Slug akan digenerate otomatis dari nama kategori.</p>
                </div>
            </div>
