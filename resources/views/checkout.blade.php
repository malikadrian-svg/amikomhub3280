...
@section('content')
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: var(--space-6);">
            ...
            <div class="card" style="padding: 0; overflow: hidden; margin-top: var(--space-4);">
                ...
                <div style="padding: var(--space-4) var(--space-6); background-color: #ffffff; border-top: 1px solid var(--slate-700); display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <span class="h3" style="margin: 0; color: var(--purple-500);">Rp 20.000</span>
                </div>
            </div>
    ...
    <div id="midtrans-overlay" class="modal-backdrop" style="display: none;">
        <div class="modal" style="padding: 0; overflow: hidden; background-color: var(--slate-800);">
            <div style="background-color: var(--purple-500); padding: var(--space-4) var(--space-6); display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--slate-700);">
                <div style="display: flex; align-items: center; gap: var(--space-2); color: #ffffff;">
                ...
                <button onclick="hideMidtrans()" class="btn" style="padding: var(--space-1); background-color: transparent; color: #ffffff; border: none;">
            ...
            <div style="padding: var(--space-6); text-align: center;">
                <p class="label" style="color: var(--slate-400); margin-bottom: var(--space-1);">TOTAL TAGIHAN</p>
                <h2 class="display" style="font-size: 36px; color: var(--purple-500); margin-bottom: var(--space-2);">Rp 20.000</h2>
                <p class="caption" style="color: var(--slate-400);">ORDER ID: #TRX-99210</p>

                <div style="margin-top: var(--space-6); display: flex; flex-direction: column; gap: var(--space-3);">
                    <button onclick="window.location.href='{{ url('/my-ticket/1') }}'" class="btn" style="width: 100%; height: 56px; justify-content: space-between; background-color: #ffffff; color: var(--slate-0); border-color: var(--slate-600);">
                ...
                <div style="margin-top: var(--space-6); display: flex; items-center; justify-content: center; gap: var(--space-2); color: var(--slate-400);">
