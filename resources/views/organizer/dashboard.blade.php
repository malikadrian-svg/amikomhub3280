...
<div style="margin-bottom: var(--space-8);">
    <h1 class="display" style="margin-bottom: var(--space-1); color: #1e293b;">Dashboard Penyelenggara</h1>
    <p class="body" style="color: #6b7280;">Selamat datang kembali. Ini adalah ringkasan kinerja event Anda.</p>
</div>
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--space-6); margin-bottom: var(--space-6);">
    ...
    <div class="card" style="padding: var(--space-6);">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: var(--space-4);">
            <div>
                <p class="caption" style="font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; margin-bottom: var(--space-1);">Potongan Platform</p>
    ...
    <div class="card" style="padding: var(--space-6);">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: var(--space-4);">
            <div>
                <p class="caption" style="font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; margin-bottom: var(--space-1);">Pendapatan Bersih</p>
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--space-6); margin-bottom: var(--space-8);">
    ...
    <div class="card" style="padding: var(--space-6);">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: var(--space-3);">
            <div>
                <p class="caption" style="font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; margin-bottom: var(--space-1);">Tiket Terjual</p>
                <h3 class="h2" style="margin: 0; color: #1e293b;">{{ number_format($totalTicketsSold, 0, ',', '.') }}</h3>
            </div>
    ...
    <div class="card" style="padding: var(--space-6);">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: var(--space-3);">
            <div>
                <p class="caption" style="font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; margin-bottom: var(--space-1);">Total Pesanan</p>
                <h3 class="h2" style="margin: 0; color: #1e293b;">{{ number_format($totalOrders, 0, ',', '.') }}</h3>
            </div>
            <div style="width: 42px; height: 42px; background: var(--purple-50); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; color: var(--purple-600);">
    ...
    <div class="card" style="padding: var(--space-6);">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: var(--space-3);">
            <div>
                <p class="caption" style="font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; margin-bottom: var(--space-1);">Total Event</p>
                <h3 class="h2" style="margin: 0; color: #1e293b;">{{ number_format($totalEvents, 0, ',', '.') }}</h3>
            </div>
            <div style="width: 42px; height: 42px; background: var(--purple-50); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; color: var(--purple-600);">
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-8);">
    ...
    <div class="card" style="padding: 0; overflow: hidden;">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding: var(--space-5) var(--space-6); border-bottom: 1px solid #f1f5f9; margin-bottom: 0;">
            <h3 class="h4" style="margin: 0; color: #1e293b;">Event Mendatang</h3>
        ...
        <div>
            @forelse ($upcomingEvents as $event)
                <div style="padding: var(--space-4) var(--space-6); display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #f1f5f9; transition: background-color 0.15s;">
                    <div style="display: flex; align-items: center; gap: var(--space-4);">
                        ...
                        <div>
                            <h4 style="font-size: 14px; font-weight: 600; color: #1e293b; margin: 0 0 2px 0;">{{ $event->title }}</h4>
    ...
    <div class="card" style="padding: 0; overflow: hidden;">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding: var(--space-5) var(--space-6); border-bottom: 1px solid #f1f5f9; margin-bottom: 0;">
            <h3 class="h4" style="margin: 0; color: #1e293b;">Pesanan Terbaru</h3>
            <a href="#" style="font-size: 13px; color: var(--purple-600); text-decoration: none; font-weight: 600;">Lihat Semua</a>
        </div>
        <div>
            @forelse ($recentOrders as $order)
                <div style="padding: var(--space-4) var(--space-6); display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #f1f5f9;">
                    <div>
                        <p style="font-size: 14px; font-weight: 600; color: #1e293b; margin: 0 0 2px 0;">{{ $order->user->name }}</p>
